...
namespace Tp2_TomasBasso
{
    public partial class Frm_MenuAdmin : Form
    {
        ...
        private void Frm_MenuAdmin_Load(object sender, EventArgs e)
        {
            horaDeApertura = DateTime.Now;
        }

        private void Frm_MenuAdmin_FormClosing(object sender, FormClosingEventArgs e)
        {
            horaDeCierre = DateTime.Now;
        }
        DateTime horaDeCierre;
        private void Frm_MenuAdmin_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void verIniciosDeSeciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            abrirformhija(new Frm_Sesion());
        }
    }
}
